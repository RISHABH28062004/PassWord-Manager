...
const Manager = () => {
    ...
    return (
        <>
            ...
            <div className="p-3 md:mycontainer min-h-[87.3vh] max-w-[1000px] mx-auto">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center w-full max-w-[1000px] mx-auto">
                    ...
                    <button onClick={savePassword} className="flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-900 cursor-pointer">
                        <lord-icon src="https://cdn.lordicon.com/jgnvfzqg.json" trigger="hover"></lord-icon>
                        Save
                    </button>
                </div>

                <div className="passwords w-full max-w-[1000px] mx-auto overflow-x-auto">
